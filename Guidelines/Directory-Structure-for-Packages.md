...
-   After adding a new Package, the script .travis/generate_travis.sh must be called from the CGAL root directory, in order for the new package to be correctly tested by Travis.
